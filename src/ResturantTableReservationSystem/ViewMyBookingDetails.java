...
public class ViewMyBookingDetails extends javax.swing.JFrame {

    public ViewMyBookingDetails() {
        initComponents();
    ...
    private void initComponents() {
        ...
        OldBookingTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Resevation ID", "Table ID", "Reservation Type", "Start Date", "Start Time", "End Time", "End Date"
            }
        ) {
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 440, 660, 290));
        ...
        UpcomingBookingTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Reservation ID", "Table ID", "Reservation Type", "Start Date", "Start Time", "End Time", "End Date"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 120, 660, 300));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ResturantTableReservationSystem/Images/background.jpg"))); // NOI18N
    ...
    public void tableDataUpcoming(){
        ...
        String tid = UpcomingBookingTable.getValueAt(r, 1).toString();
        String rtype = UpcomingBookingTable.getValueAt(r, 2).toString();
        String sDate = UpcomingBookingTable.getValueAt(r, 3).toString();
        String sTime = UpcomingBookingTable.getValueAt(r, 4).toString();
        String eTime = UpcomingBookingTable.getValueAt(r, 5).toString();
        String eDate = UpcomingBookingTable.getValueAt(r, 6).toString();
    ...
    public void tableDataOld(){
        ...
        String rid = OldBookingTable.getValueAt(r, 0).toString();
        String cid = String.valueOf(Customer.id);
        String tid = OldBookingTable.getValueAt(r, 1).toString();
        String rtype = OldBookingTable.getValueAt(r, 2).toString();
        String sDate = OldBookingTable.getValueAt(r, 3).toString();
        String sTime = OldBookingTable.getValueAt(r, 4).toString();
        String eTime = OldBookingTable.getValueAt(r, 5).toString();
        String eDate = OldBookingTable.getValueAt(r, 6).toString();
    ...
    public void tableLoadUpcoming(){
        ...
        ReservationController.viewUpcomingReservatonDetails();
        
        try{
            
            UpcomingBookingTable.setModel(DbUtils.resultSetToTableModel(ReservationController.rs));
            ...
            try{
                ...
                ReservationController.rs.close();
                ReservationController.pst.close();
            }catch(Exception e){
    ...
    public void tableLoadOld(){
        ...
        ReservationController.viewOldReservatonDetails();
        
        try{
            
            OldBookingTable.setModel(DbUtils.resultSetToTableModel(ReservationController.rsLoad));
            ...
            try{
                ...
                ReservationController.rsLoad.close();
                ReservationController.pstLoad.close();
            }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewMyBookingDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
