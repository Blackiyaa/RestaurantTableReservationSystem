...
public class makeReservation extends javax.swing.JFrame {
    ...
    private void initTabbedPaneListener() {
        tabbedPaneCustom1.addChangeListener(new javax.swing.event.ChangeListener() {
    ...
    private void initComponents() {
        ...
        tabbedPaneCustom1 = new Animations.TabbedPaneCustom();
        ...
        jPanel1.add(BookBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 680, -1, -1));
        ...
        tabbedPaneCustom1.setBackground(new java.awt.Color(0, 0, 0,80));
        tabbedPaneCustom1.setSelectedColor(new java.awt.Color(0, 204, 0));
        ...
        tabbedPaneCustom1.addTab("Single Date Booking", jPanel3);
        ...
        tabbedPaneCustom1.addTab("Continous Period Booking", jPanel4);
        ...
        tabbedPaneCustom1.addTab("Specific Days Booking", jPanel5);

        jPanel1.add(tabbedPaneCustom1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 270, 710, 370));
            ...
            if(rType.equals("Book For Single Date")){
                        ...
                        if(ReservationController.checkStartTimeWithEndTime(startTime, endTime)){
                            if(ReservationController.checkEqualityDateWithCurrentDate(startDate, startDate)==true){
                                if(ReservationController.checkEqualityDateWithCurrentTime(startDate, startTime, endTime)==true){
                                        ...
                                        CustomerController.insertReservationForSingleBooking(res);
                ...
                try{
                    if(!startDateC.equals(null)&&!endDateC.equals(null)&&!startTC.equals("...")&&!endTC.equals("...")&&!tid.equals("Select a table")){
                            ...
                            if(ReservationController.checkEqualityStartDateWithEndDate(startDateC, endDateC)){
                                if(ReservationController.checkEqualityDateWithCurrentDate(startDateC, startDateC)==true){
                                    if(ReservationController.checkEqualityDateWithCurrentTime(startDateC, startTimeC, endTimeC)==true){
                                            ...
                                            CustomerController.insertReservationForContinousBooking(res);
                        ...
                        JOptionPane.showMessageDialog(null, "Please fill in all fields of Book For Continous Period","Error",JOptionPane.ERROR_MESSAGE);
                    }
                }catch(Exception e){
                                    ...
                                    if(ReservationController.checkEqualityDateWithCurrentDate(startDateS, startDateS)==true){
                                        if(ReservationController.checkEqualityDateWithCurrentTime(startDateS, startTimeS, endTimeS)==true){
                                                ...
                                                for(LocalDate sDate : specificDays){
                                                    ...
                                                    CustomerController.insertReservationForSpecificBooking(res,sDate);
    ...
    private Animations.TabbedPaneCustom tabbedPaneCustom1;
