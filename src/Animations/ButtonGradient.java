...
public class ButtonGradient extends JButton{
    ...
    private Color color1=Color.decode("#00bf8f");
    private Color color2=Color.decode("#001510");
    private final Timer timer;
    private final Timer timerPressed;
    private float alpha = 0.3f;
    private boolean mouseOver;
    private boolean pressed;
    private Point pressedLocaion;
    ...
    private void paintPressed(Graphics2D g2){
        if(pressedLocaion.x-(pressedSize/2)<0&&pressedLocaion.x+(pressedSize/2)>getWidth()){
        ...
        float x = pressedLocaion.x-(pressedSize/2);
        float y = pressedLocaion.y-(pressedSize/2);
